...
const Card = props => {
	...
	return (
		<div className='flex gap-10 rounded-md overflow-hidden mb-12 shadow-md hover:shadow-sm transition-shadow'>
			...
			<div className='flex-1 flex flex-col justify-center align-item items-start gap-3 px-5 '>
				<div className="">{category}</div>
				<Link href={`/blog/${slug}`} className="hover:underline"><h2>{title}</h2></Link>
